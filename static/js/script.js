...
textToAppend = `<li id = "usermessage" ${currentUser == data['names'] ? 'style="background-color: #606770;height:20px;border-radius:8px;width:200px;margin-bottom:20px;margin:10px;color:white;position:relative;left:60%;" >' : '>' } ${data['names']} : ${data['messages']}`
